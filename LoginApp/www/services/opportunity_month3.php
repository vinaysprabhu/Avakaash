<?php
require("../js/conn.php");
$stmt = $con->prepare("SELECT * FROM opportunity_master WHERE YEAR(opportunity_date) = YEAR(NOW() + INTERVAL 2 MONTH) AND MONTH(opportunity_date)=MONTH(NOW() + INTERVAL 2 MONTH) AND
