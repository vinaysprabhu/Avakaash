<?php
require("../js/conn.php");
$stmt = $con->prepare("SELECT * FROM opportunity_master WHERE YEAR(opportunity_date) = YEAR(NOW()) AND MONTH(opportunity_date)=MONTH(NOW()) AND opportunity_date >= CURDATE()  ORDER BY opportunity_date ASC");
